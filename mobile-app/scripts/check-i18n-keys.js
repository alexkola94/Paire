 ...
 * Run from mobile-app: node scripts/check-i18n-keys.js
 */
...
/**
 * Find all JS/JSX files under dir, excluding node_modules.
 */
function findJsFiles(dir, files = []) {
  ...
  for (const e of entries) {
    ...
    if (e.name === 'node_modules' || e.name === '.expo' || e.name === 'scripts') continue;
