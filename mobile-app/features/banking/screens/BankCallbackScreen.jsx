      ...
      <View style={[styles.card, { backgroundColor: theme.colors.surface }]}>
        ...
        {status === 'success' && (
          <>
            ...
            <Text style={[styles.title, { color: theme.colors.text }]}>{t('common.success', 'Success!')}</Text>
        ...
        {status === 'error' && (
          <>
            ...
            <Text style={[styles.title, { color: theme.colors.text }]}>{t('common.error', 'Error')}</Text>
            <Text style={[styles.message, { color: theme.colors.textSecondary }]}>{message}</Text>
            <Text style={[styles.hint, { color: theme.colors.textLight }]}>
              {t('profile.openBanking.callback.closing', 'This window will close automatically...')}
            </Text>
...
const styles = StyleSheet.create({
  ...
  card: { borderRadius: borderRadius.lg, padding: spacing.xl, alignItems: 'center', maxWidth: 360, width: '100%' },
  title: { ...typography.h2, marginTop: spacing.lg, textAlign: 'center' },
  message: { ...typography.body, marginTop: spacing.sm, textAlign: 'center' },
  hint: { ...typography.bodySmall, marginTop: spacing.md, textAlign: 'center' },
});
