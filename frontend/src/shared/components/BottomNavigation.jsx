        ...
        >
            <div className="bottom-nav-container">
                <NavLink
                    to="/dashboard"
                    className="nav-item"
                    onMouseEnter={() => preloadRoute(() => import('../../features/finance/pages/Dashboard'))}
                    onFocus={() => preloadRoute(() => import('../../features/finance/pages/Dashboard'))}
                >
                ...
                <NavLink
                    to="/expenses"
                    className="nav-item"
                    onMouseEnter={() => preloadRoute(() => import('../../features/finance/pages/Expenses'))}
                    onFocus={() => preloadRoute(() => import('../../features/finance/pages/Expenses'))}
                >
                    <div className="icon-container">
                    ...
                    {createPortal(
                        <div className={`fab-menu ${showFabMenu ? 'open' : ''}`}>
                            <NavLink
                                ...
                                onMouseEnter={() => preloadRoute(() => import('../../features/finance/pages/Income'))}
                                onFocus={() => preloadRoute(() => import('../../features/finance/pages/Income'))}
                            >
