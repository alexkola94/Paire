...
const ROUTE_PREFETCH_MAP = {
  '/dashboard': () => import('../../features/finance/pages/Dashboard'),
  '/expenses': () => import('../../features/finance/pages/Expenses'),
  '/income': () => import('../../features/finance/pages/Income'),
  '/budgets': () => import('../../features/finance/pages/Budgets'),
  '/analytics': () => import('../../features/analytics/pages/Analytics'),
  '/profile': () => import('../../features/profile/pages/Profile'),
  '/reminders': () => import('../../features/notifications/pages/ReminderSettings')
}
const prefetchRoute = (path) => {
  const fn = ROUTE_PREFETCH_MAP[path]
  if (fn) preloadRoute(fn)
}
const prefetchTravelApp = () => preloadRoute(() => import('../../features/travel/TravelApp'))
