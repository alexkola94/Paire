        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    auto_pay = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    reminder_days = table.Column<int>(type: "integer", nullable: false, defaultValue: 3),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    estimated_total = table.Column<decimal>(type: "numeric", nullable: true),
                    actual_total = table.Column<decimal>(type: "numeric", nullable: true),
                    notes = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
