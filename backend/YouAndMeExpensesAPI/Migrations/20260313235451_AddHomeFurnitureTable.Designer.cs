...
namespace YouAndMeExpensesAPI.Migrations
{
    ...
    [Migration("20260313235451_AddHomeFurnitureTable")]
    partial class AddHomeFurnitureTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YouAndMeExpensesAPI.Models.HomeFurniture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("FurnitureCode")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.HasIndex("UserId", "RoomName", "FurnitureCode")
                        .IsUnique();

                    b.ToTable("home_furniture", (string)null);
                });
            ...
            modelBuilder.Entity("YouAndMeExpensesAPI.Models.PushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("YouAndMeExpensesAPI.Models.ReminderPreferences", b =>
                {
                    ...
                    b.Property<string>("DashboardOverviewMode")
                        .HasColumnType("text")
                        .HasColumnName("dashboard_overview_mode");
            ...
            modelBuilder.Entity("YouAndMeExpensesAPI.Models.TravelNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("travel_notes", (string)null);
                });

            modelBuilder.Entity("YouAndMeExpensesAPI.Models.TravelNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("travel_notifications", (string)null);
                });

            modelBuilder.Entity("YouAndMeExpensesAPI.Models.TravelNotificationPreferences", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("BudgetExceededEnabled")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("budget_exceeded_enabled");

                    b.Property<bool>("BudgetThreshold75Enabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("budget_threshold_75_enabled");

                    b.Property<bool>("BudgetThreshold90Enabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("budget_threshold_90_enabled");
                    ...
                    b.Property<string>("DocumentExpiryDays")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasDefaultValue("30,14,7,1")
                        .HasColumnName("document_expiry_days");

                    b.Property<bool>("DocumentExpiryEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("document_expiry_enabled");
                    ...
                    b.Property<string>("ItineraryReminderHours")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasDefaultValue("24,6,1")
                        .HasColumnName("itinerary_reminder_hours");

                    b.Property<bool>("ItineraryRemindersEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("itinerary_reminders_enabled");

                    b.Property<bool>("PackingProgressEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("packing_progress_enabled");
                    ...
                    b.Property<int>("TripApproachingDays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(7)
                        .HasColumnName("trip_approaching_days");

                    b.Property<bool>("TripApproachingEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("trip_approaching_enabled");
                    ...
                    b.ToTable("travel_notification_preferences", (string)null);
                });
