...
> **Note:** The canonical, project-wide changelog lives at the repository root in `CHANGELOG.md`. This `docs/CHANGELOG.md` file is a documentation-focused summary that highlights major architecture and feature milestones.
...
- Soft purple primary color scheme
